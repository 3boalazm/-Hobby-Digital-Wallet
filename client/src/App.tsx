...
import HorizonFoundationPage from './pages/HorizonFoundationPage'
  ...
  return (
    <TranslationProvider>
      ...
      <Routes>
        ...
        />
        {/* Horizon dashboard foundation — not linked from any nav yet. */}
        <Route
          path="/horizon-foundation"
          element={
            <ProtectedRoute>
              <HorizonFoundationPage />
            </ProtectedRoute>
          }
        />
