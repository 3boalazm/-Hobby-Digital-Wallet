...
// Same-origin '/api' by default — correct for the normal self-hosted/Docker
// deployment (server/public serves this build alongside the API). Set
// VITE_API_URL (e.g. on Vercel) to point a statically-hosted build at a
// separately-hosted TREK server instead; leaving it unset changes nothing.
