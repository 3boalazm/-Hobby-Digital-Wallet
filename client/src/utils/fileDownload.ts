...
/**
 * Downloads in-memory text (e.g. a generated CSV) as a file. Unlike
 * downloadFile() above, there's no server fetch or offline-cache fallback
 * here — the content is already in hand (e.g. Reports' export, built from
 * data already loaded into the page), so this just wraps it in a Blob and
 * reuses the same anchor-click download mechanism.
 */
/**
